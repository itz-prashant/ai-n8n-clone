...
-- CreateIndex
CREATE UNIQUE INDEX "Connection_fromNodeId_tomNodeId_fromOutput_toInput_key" ON "Connection"("fromNodeId", "tomNodeId", "fromOutput", "toInput");
...
-- AddForeignKey
ALTER TABLE "Connection" ADD CONSTRAINT "Connection_tomNodeId_fkey" FOREIGN KEY ("tomNodeId") REFERENCES "Node"("id") ON DELETE CASCADE ON UPDATE CASCADE;
